...
import pytesseract
import pyttsx3  
from frame_msg.frame_msg import FrameMsg, RxPhoto, TxCaptureSettings, TxSprite, TxImageSpriteBlock
...
def extract_text(image):
    ...
    print(f"✓ Best result: {best_method} with {best_length} characters")
